...
import { loadSavedGames, isAuthenticated, getCurrentUser } from '../../lib/appwrite';
...
const GamePage = () => {
  ...
  const handleAction = useCallback(async (action) => {
    ...
    setLoading(true);
    try {
      const { updatedGameState, storyUpdate } = await performAction(gameState.userId, gameState, action);

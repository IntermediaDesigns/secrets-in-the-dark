...
const Navbar = ({ user: initialUser }) => {
  ...
  return (
    <nav
      className={`theme-bg-primary theme-text w-full shadow-md transition-colors duration-300 ${theme}`}
    >
      <div className="container mx-auto flex justify-between items-center py-2 px-6">
        <Link href="/" className="theme-text text-2xl font-bold">
          <img
            src="/secret-logo.png"
            alt="logo"
            className="w-20 h-auto hover:transform hover:scale-105"
          />
        </Link>
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/game"
                className="theme-bg-accent theme-text-accent hover:theme-bg-accent-hover font-semibold text-lg py-2 px-4 rounded transition-colors duration-300"
              >
                Play Game
              </Link>
              <button
